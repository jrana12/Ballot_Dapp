App = {
  ...
  chairPerson:null,
  currentAccount:null,
  //init function is used to load the voting data stored in proposals.json file
  init: function() {
  ...
  //Fill drop-down with various address options which are to be chosen to register
  ...
  //ChairPerson i sthe account which initializes the Smart Contract
  ...
  //Register new voter (Done by the ChairPerson Account)
